	...
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box">
					<input type="checkbox" id="is_allow" name="is_allow" value="1" @if($artFind->is_allow) checked @endif>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box">
					<input type="checkbox" name="is_page" value="1" id="checkbox-moban" @if($artFind->is_page) checked @endif>
